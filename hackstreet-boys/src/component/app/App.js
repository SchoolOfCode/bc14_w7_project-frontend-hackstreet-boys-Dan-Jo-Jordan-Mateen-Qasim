...
function App() {
    ...
    function handleClick() {
        ...
        appDiv.style.backgroundColor = `whitesmoke`;
    }

    return (
        <div className="App">
        {buttonClicked ? <p></p> : <h1>The Hackstreet Boys Present...</h1> }
        {buttonClicked ? <h2 className = "black">The School of Code Roadmap App</h2> : <h2 className="white">The School of Code Roadmap App</h2> }
